...
class SchoolConfig(AppConfig):
    ...
    def ready(self):
        ...
        from . import supervisor_followup_models  # noqa: F401
        ...
        from .supervisor_followup_views import (
            supervisor_visit_list,
            supervisor_visit_report,
            supervisor_visits_report,
        )
        views.school_info_view = school_info_view
        views.academic_achievement_report = academic_achievement_report
        views.supervisor_visit_list = supervisor_visit_list
        views.supervisor_visit_report = supervisor_visit_report
        views.supervisor_visits_report = supervisor_visits_report
