...
urlpatterns = [
    ...
    path('schedule/plan/<int:plan_id>/entry/<int:entry_id>/move/', views.schedule_entry_move, name='schedule_entry_move'),
    ...
    path('schedule/plan/<int:plan_id>/teacher-report/', views.schedule_teacher_report, name='schedule_teacher_report'),
