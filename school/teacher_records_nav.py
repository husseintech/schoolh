class TeacherRecordsNavigationMiddleware:
    ...
    def __call__(self, request):
        ...
        if role == 'admin' and request.path.rstrip('/') == '/reset-data' and 'teacher-records-reset-link' not in html:
            anchor = '<a href="/administration/teacher-records/reset/" id="teacher-records-reset-link" class="btn btn-outline-danger"><i class="bi bi-eraser"></i> تفريغ سجل المنهاج وسجل الدورات</a> '
