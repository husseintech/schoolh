...
urlpatterns = [
    ...
    path('school-radio/<int:entry_id>/files/upload/start/', radio_views.school_radio_upload_start, name='ol_school_radio_upload_start'),
    path('school-radio/<int:entry_id>/files/upload/chunk/', radio_views.school_radio_upload_chunk, name='ol_school_radio_upload_chunk'),
